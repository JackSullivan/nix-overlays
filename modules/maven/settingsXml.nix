...
cfg: let
  ...
  profiles.profile = mapAttrsToList (id: args@{repositories, ...}: {inherit id; repositories = mkRepositories repositories;} // (optionalAttrs (builtins.hasAttr "properties" args) {properties = args.properties;})) cfg.profiles;
